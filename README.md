# IT23663718 – IT3040 Assignment 1

##  Project Title
Automated Testing for Singlish to Sinhala Transliteration System

##  Repository
https://github.com/SewminiTheekshana/IT23663718-ITPM
...
- it23663718_test_automation.py           → Playwright automation script  
- IT23663718_Assignment 1 - Test cases.xlsx → Excel file with test cases & results  
- it23663718_requirements.txt             → Python dependencies  
- it23663718_README.md                    → Project documentation  
...
4. Run the automation script  
   python test_automation.py --excel "IT23663718_Test cases.xlsx" --url "https://www.pixelssuite.com/chat-translator"  
